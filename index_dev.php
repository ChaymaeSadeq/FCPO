...
<head>
    ...
    <title>FCPO- Dashboard/Dev</title>
        ...
        <div class="content-body">
            ...
            <div class="row" id="row">
              <?php
                    ...
                    $req1="SELECT j.id_user,p.num_projet,p.titre,p.date_livraison,c.nom,p.id_etat FROM projet p,client c,user_projet j where p.id_client=c.id_client and j.num_projet=p.num_projet and j.id_user=".$_SESSION['iduser']." ";
                    ...
                    <div class='head'>
                            <h4>".$ligne1->titre. " </h4>
                            <a href='Projetdetails-dev.php?idP= ".$id ."' class='view' ><i class='zmdi zmdi-eye'>". $id."</i></a>
                        </div>
                        <div class='content'>
                            <h3>". $ligne1->nom ."</h3>
            ...
            <div class="row mbn-30">
                ...
                <div class="col-md-8 mb-30">
                    <div class="box">
                        <div class="box-head">
                            <h4 class="title">Projets par mois</h4>
                        </div>
                        <!--chart-->
                        <div class="box-body">
                            <div class="chart-legends-1 row">
                                                          </div>
                            <div class="chartjs-revenue-statistics-chartt">
                                <canvas id="chartjs-revenue-statistics-chartt"></canvas>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="chartjs-market-trends-chartt">
                                <canvas id="chartjs-market-trends-chartt"></canvas>
