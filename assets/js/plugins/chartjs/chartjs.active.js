(function ($) {
    ...
    if( $('#chartjs-revenue-statistics-chartt').length ) {
        $(document).ready(function(){
          $.get("data1.php",
                 function(data){
                  console.log(data);
        var RSC = document.getElementById('chartjs-revenue-statistics-chartt').getContext('2d');
        var RSCconfig = {
            type: 'line',
            data: {
                ...
                datasets: [{
                    label: 'Projet',
                    data: [data[1],data[3],data[5],data[7],data[9],data[11],data[13],data[15],data[17],data[19],data[21],data[23]],
  ...
  if( $('#chartjs-market-trends-chartt').length ) {
      $(document).ready(function(){
          $.get("data.php",
                 function(data){
                  console.log(data);
        var MTC = document.getElementById('chartjs-market-trends-chartt').getContext('2d');
        var MTCconfig = {
            type: 'doughnut',
            data: {
                labels: ['En cours', 'Suspendu', 'Terminé', 'Annulé'],
                datasets: [{
    ...
    if( $('#example-chartjs-barV').length ) {
        ...
        var ECBVconfig = {
            type: 'bar',
            data: {
                labels: ['Ilham chiki', 'Loubna Lhssaini', 'Chaymae ch','hafsa Ajmid', 'shéba shoushou','mimi mmimi'],
                datasets: [{
                    label: 'En cours',
                    data: [10,20,27,50,60,90],
                    backgroundColor: '#fb7465',
                    fill: false,
                },
                {
                    label: 'Suspendu',
                    data: [50,60,90,70,85,90],
                    backgroundColor: '#fb7da4',
                    fill: false,
                },
                {
